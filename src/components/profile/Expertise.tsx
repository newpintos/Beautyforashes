...
export function Expertise() {
    ...
    return (
        <section id="expertise" className="py-10 bg-gradient-to-t from-white to-brand-soft/20 overflow-hidden">
            ...
            <div className="flex flex-col gap-8 pause-on-hover max-w-5xl mx-auto">
